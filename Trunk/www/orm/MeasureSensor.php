...
abstract class MeasureSensor extends Table{
    ...
    **/
    public function getAll(){
       $query = "SELECT ".
                 ...
                 WHERE ".$this->hardwareTable.".hardwareName = '".$this->sensor_name."'
    ...
    **/
	...
	public function getRows($cond){
            ...
            $query = "SELECT ".
                 ...
                 FROM ".$this->name."
                 INNER JOIN ".$this->hardwareTable."
                 WHERE ".$this->hardwareTable.".hardwareName = '".$this->sensor_name."' AND ".$where."
                 ORDER BY timestamp DESC";
